...
mAA1 = readmatrix('result/mAA.csv');
data_names = {
    'Alamo', 'Ellis Island', 'Gendarmenmarkt', 'Madrid Metropolis',...
    'Montreal ND', 'NYC Library', 'Notre Dame', 'Piazza del Popolo',...
    'Piccadilly', 'Roman Forum', 'Tower of London',...
    'Union Square', 'Vienna Cathedral', 'Yorkminster'};

figure('Position', [100, 100, 1200, 400]);
bar_handle = bar(1:14,mAA1, 'grouped');
...
% Set y-axis label with a larger font size
ylabel('mAA(10^\circ)', 'FontSize', 14);

% Add a legend with a more readable font size
legend('RANSAC','DEGENSAC','LO-RANSAC','TME','FMS','SFMS','STE', 'FontSize', 10,'Location','best');
