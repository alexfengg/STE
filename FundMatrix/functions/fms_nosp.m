function [ Lf,Lc,Si ] = fms_nosp( X , d , options  )
...
%% FMS_nosp: FMS without spherizing the data
%   The default fms has the step of spherizing the data
%   fms_nosp: remove the step of spherizing
